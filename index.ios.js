 ...
 **********************************************************************************/
 ...
 import { CameraPlusBase, CameraVideoQuality, CLog, GetSetProperty } from './common';
 export * from './common';
 ...
 export class CameraPlus extends CameraPlusBase {
     ...
     disposeNativeView() {
         ...
         this._swifty.videoDevice.lockForConfiguration()
         this._swifty.videoDevice.videoZoomFactor = 1.0
         this._swifty.videoDevice.unlockForConfiguration()
 ...
 const drawToggle = function (color) {
     const iconColor = new Color(color || '#fff').ios;
     //// Bezier Drawing
     const bezierPath = UIBezierPath.bezierPath();
 ...
 const drawPicOutline = function (color) {
     const iconColor = new Color(color || '#fff').ios;
     //// Bezier Drawing
     // Outer ring
     const bezierPath = UIBezierPath.bezierPath();
 ...
 const drawGallery = function (color) {
     const iconColor = new Color(color || '#fff').ios;
     //// Bezier Drawing
     const bezierPath = UIBezierPath.bezierPath();
